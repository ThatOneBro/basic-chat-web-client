...
export interface IReconnectingWebSocket extends EventTarget {
  readyState: number;
...
const Events = {
  Event: (typeof globalThis.Event !== 'undefined'
    ? globalThis.Event
    : undefined) as typeof globalThis.Event | undefined,
...
function lazyInitEvents(): void {
  if (typeof globalThis.Event === 'undefined') {
    throw new Error(
      'Unable to lazy init events for ReconnectingWebSocket. globalThis.Event is not defined yet'
    );
  }
  ...
  Events.CloseEvent = class CloseEvent extends Event implements CloseEvent {
    ...
    // biome-ignore lint/style/useDefaultParameterLast: Matches `CloseEvent` signature in Node
